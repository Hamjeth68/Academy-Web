                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="color:#393d47;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; color: #393d47; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 17px;">
                                            <p class="para"> </p>
                                            <p class="para">Dear Student,</p>
                                            <p class="para"> </p>
                                            <p class="para">Thank you for enrolling with Safeenviro Academy</p>
                                            <p class="para"> </p>
                                            <p class="para">Purchase order confirmation number <b>{{$refNumber}}</b></p>
                                            <p class="para"> </p>
                                            ...
                                            <p class="para"> </p>
                                            <p class="para">We wish you good luck!</p>
                                            <p class="para"> </p>
                                            <p class="para"> </p>
                                            <p class="para">Admissions</p>
                                            <p class="para">Safeenviro Academy</p>
                                            <p class="para"> </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
