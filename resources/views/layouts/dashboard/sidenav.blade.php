<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html"
        target="_blank">
        <img src={{ asset('img/AcLogo.png') }} class="navbar-brand-img h-100" alt="main_logo">
...
<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link {{ \Illuminate\Support\Facades\Route::getCurrentRoute()->uri == 'dashboard' ? 'active' : '' }}"
                href={{ url('/dashboard') }}>
                <div
        ...
        <li class="nav-item">
            <a class="nav-link {{ \Illuminate\Support\Facades\Route::getCurrentRoute()->uri == 'dashboard/products' ? 'active' : '' }}"
        ...
        <li class="nav-item">
            <a class="nav-link {{ \Illuminate\Support\Facades\Route::getCurrentRoute()->uri == 'dashboard/currency' ? 'active' : '' }}"
                href={{ url('/dashboard/currency') }}>
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{ \Illuminate\Support\Facades\Route::getCurrentRoute()->uri == 'dashboard/users' ? 'active' : '' }}"
        ...
        <li class="nav-item">
            <a class="nav-link {{ \Illuminate\Support\Facades\Route::getCurrentRoute()->uri == 'dashboard/profile' ? 'active' : '' }}"
