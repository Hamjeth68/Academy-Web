    ...
    <script>
        ...
        const courses = [
            ...
            },
            {
                ...
                endDate: "11 Jun 2021",
                startTime: "08.00 Am",
                title: "Fire Safety on Waste Sites",
                fees: 35,
                status: "Available",
            },
        ];
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row col-lg-6 col-md-auto float-right">
                        ...
                        <h1 class="float-right px-1" id="forex-amount-1">40</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row col-lg-6 col-md-auto float-right">
                        ...
                        <h1 class="float-right px-1" id="forex-amount-2">35</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row col-lg-6 col-md-auto float-right">
                        ...
                        <h1 class="float-right px-1" id="forex-amount-3">35</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row col-lg-6 col-md-auto float-right">
                        ...
                        <h1 class="float-right px-1" id="forex-amount-5">40</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row col-lg-6 col-md-auto float-right">
                        ...
                        <h1 class="float-right px-1" id="forex-amount-6">35</h1>
