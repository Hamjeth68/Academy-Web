...
<body>
            ...
            <div class="social-links">
                ...
                @if (auth()->check())
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="d-inline-block">
                        ...
                        @csrf
                        <a href="{{ route('logout') }}" class="text-black-50 font-weight-bold" onclick="event.preventDefault();
        ...
        <section id="featured-services" class="featured-services">
            ...
            <div class="row pt-5 mr-0 ml-0">
                @foreach ($products as $product)
                    <div class="col-md-6 col-lg-4 text-center" style="padding: 50px; padding-top:10px"
                        ...
                        <div class="btn-con mt-2" data-aos="flip-up">
                            <button class="btn btn-lg btn-custom-green custom-btn" data-toggle="modal"
                                data-target="#course-{{ $product->id }}">View Course</button>
                            {{-- <a href="{{ url('book-now') }}"><button class="btn btn-lg btn-custom-blue custom-btn ml-1 float-right">Pay Here</button></a> --}}
                        </div>

                    </div>

                    <div class="modal fade" id="course-{{ $product->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row col-lg-6 col-md-auto float-right">
                                        ...
                                        {{-- @endforeach --}}
                                        {{-- </select> --}}
                                        <h1 class="float-right px-1" id="forex-amount">£
                                            {{ number_format($product->p_amount, 2) }}</h1>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="d-flex justify-content-center align-content-center text-center">
                        <a href="https://www.lawmaacademy.com/" class="logo mr-auto"><img
                                src={{ asset('img/lawmaimages/logo.png') }} alt="" style="width: 70%;"></a>
                    </div>
                    <div class="col-auto"></div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="">
                        <p class="text-black-100">
                            LAWMA Academy is an educational platform for literacy improvement and career development in
                            waste management. We offer credible hands-on waste management tutelage and programs to all
                            stakeholders in waste management businesses including organisations, professionals, facility
                            managers, students and other public and private entities.
                            <br></br>
                            LAWMA Academy provides the citadel for learning, knowledge exchange, networking, and
                            expertise development for design, adoption and implementation of sustainable waste
                            management solutions.
                            <br></br>
                            LAWMA Academy is therefore the knowledge hub of waste management.
                            As the name implies, this training will cover special areas of interest in waste management
                            as waste management processes are more advanced than just collection, transportation and
                            disposal at landfills.
                            It comprises different areas like Resource Recovery & Waste Management, Smarter Solutions
                            for Segregation & Logistics, Fleet Management, Waste Recycling, waste PSP models, Waste
                            Financing, Waste Audits, Forensic Waste Analysis, Waste to wealth etc.
                            This training will improve participants skills in waste management, promote efficiency and
                            afford participants the opportunity to translate what they have learnt to innovative
                            business ideas that will make them financially independent, solve waste management problems
                            and create employment which will help boost the economy.
                            This training will engage key stakeholders from environmental consultants, professionals who
                            work in the waste management sector or on waste management infrastructural projects, project
                            managers, administrators, coordinators and other professionals who work on community based
                            projects.
                            Trainings will be designed for interested applicants in special area of interest in waste
                            management on need assessment.
                ...
                <div class="row">
                    <div class="col text-center">
                        <a href="https://www.lawmaacademy.com/"><button type="button" class="btn btn-primary btn-lg"><i
                                    class="fa fa-arrow-circle-right mr-2"></i>Visit LAWMA Academy</button></a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="icon-box" data-aos="flip-left" data-aos-delay="100">
                            <div class="icon"><img class="Card-lawimg" src={{ asset('img/portal/Training.jpg') }}
                    ...
                    <div
                        ...
                        <div class="icon-box" data-aos="flip-left" data-aos-delay="200">
                            <div class="icon"><img class="Card-lawimg" src={{ asset('img/portal/Consultant.jpg') }}
                                    alt="" style="margin-left: -15px;"></div>
                            <h3 class="title-lawma">Consulting</h3>
                            <p class="lawma-para">Multi-disciplinary consultancy specializing in the areas of
                                environment, waste management, planning, engineering and logistics</p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 footer-contact">
                        <p>At SafeEnviro Academy we offer the highest quality of academic and professional experience in
                            the Waste, Resource & Environmental Industry whilst working closely with some of the leading
                            professional membership organizations in the sector.
                            By studying with us, you will be part of a community driven by a desire to create a safer
    ...
    <div class="modal fade" id="course1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer col-lg-12">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <a href="{{ url('book-now') }}"><button type="button" class="btn btn-primary">Enroll
                            Now</button></a>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="course2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        ...
                        Who can participate?<br>
                        This course is for anyone new to the waste and resources sector, those currently dealing with
                        their organization’s waste and resources, and anyone wishing to develop or change their career.
                        It is particularly relevant to those in the local authority and private sector and those who
                        need to understand International waste policy
    ...
    <div class="modal fade" id="course3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="course4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="course5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <h4>What this cover</h4>
                    <p>
                        • Understand how and why landfill gas is produced, what effects it can have on the natural and
                        built environment and best practice in managing the gas<br>
    ...
    <div class="modal fade" id="course6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="course7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <p><strong>
                            The Fire Safety Course is designed to raise awareness of fire hazards in the workplace and
                            how to act
                            safely in the event of an emergency fire situation, including selecting and using the
                            correct fire
                ...
                <div class="modal-body">
                    ...
                    This course is ideal for anyone interested in understanding how fires start and continue, identify
                    the
                    dangers of fire, understand the effects of fire, know how to react in an emergency, understand when
                    and
