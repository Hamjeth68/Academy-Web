                    ...
                    <td class="border px-4 py-2">
                        <div class="col-md-6">
                            <button class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#editCurrency-{{ $currency->id }}" type="button">
                                {{ __('Edit Currency') }}
                            </button>
                ...
                <div class="modal fade" id="editCurrency-{{ $currency->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="card-body">
                                <form action="{{ url('/dashboard/currency/edit/'.$currency->id) }}" class="contact100-form validate-form"
                                      method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="exchange_rate" type="text"
                                                   ...
                                                   name="exchange_rate" value="{{isset($currency->exchange_rate) ? $currency->exchange_rate : ''}}"
